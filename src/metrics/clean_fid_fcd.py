...
def compute_clean_fid(cfg, logger: logging.Logger, real_image_save_path, sample_image_save_path):
...
def compute_fcd(cfg, logger: logging.Logger, real_image_save_path, sample_image_save_path):
