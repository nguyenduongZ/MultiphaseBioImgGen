...
class PatchEmbed(nn.Module):
    def __init__(
        ...
        pathes_resolution = [img_size[0] // patch_size[0], img_size[1] // patch_size[1]]
        
        self.img_size = img_size
        self.patch_size = patch_size
        self.pathes_resolution = pathes_resolution
        self.num_patches = pathes_resolution[0] * pathes_resolution[1]
