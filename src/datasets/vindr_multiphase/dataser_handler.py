...
class VinDrMultiphase(Dataset):
    ...
    def __init__(self, cfg, split: str):
        self.cfg = cfg
        self.split = split
        self.return_3d = self.cfg.data.return_3d
        ...
        if self.return_3d:
            ...
            self.group_keys = list(self.grouped_df.groups.keys())
    ...
    def __getitem__(self, idx):
        ...
        if self.return_3d:
            ...
            volume = volume.unsqueeze(0) # (1, N, D, H, W)
            logging.info(f"Volume shape: {volume.shape}")
            return volume, text_embedding, label
