...
def t5_tokenize(
    ...
    device = torch.device("cuda" if torch.cuda.is_available() else "cpu", index=device_index)
...
def t5_encode_text(
    ...
    token_ids, attn_mask = t5_tokenize(texts, name = name, device_index=device_index)
